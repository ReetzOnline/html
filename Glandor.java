/**Lauritta Burrows 9th September 2020
...
public class Game8 {
  ...
  public static void main(String[] args) {
    ...
    Player rb = new Player("Rita", 46, "female");
    ...
    System.out.printf("%n\bHi %s. %n%nYou are currently floating above a magical cottage. On your back is an empty bag which acts as your inventory. Find the clues to take you to your destiny. %n%n\b"
      + "Type 'help' (no quotation marks) at any time.%n%n", rb.getName());
    System.out.println(" ");
    ...
    while (quit!=true){
        ...
        switch(command){
            ...
            //|Lounge
            case "north": System.out.printf(directions, lounge.getRoom(), lounge.getFurnishings()); break;
            ...
            //bathroom
            case "south": System.out.printf(directions, bathroom.getRoom(), bathroom.getFurnishings()); break;
            ...
            case "search cabinet": System.out.printf(findings, letter.getItem(), letter.getHidingSpot());
            ...
            //bedroom
            case "east": System.out.printf(directions, bedroom.getRoom(), bedroom.getFurnishings()); break;
            ...
            case "look chest": System.out.printf(distanceView, chest.getType());
            ...
            //Kitchen
            case "west": System.out.printf(directions, kitchen.getRoom(), kitchen.getFurnishings()); break;
            ...
            case "search oven": System.out.println(nonSpecial); break;
            ...
            case "search fridge": if(shootPad){System.out.println("You notice a secret passage leading down into the earth. Take a rest and check your inventory. "); inventory();
...
public static void help(){
      System.out.printf("Commands here are case sensitive. Use any of the following commands to help you on your journey:%n%n\b"
              ...
              + "hint - to get an assist, if you're stuck, but only if you really need it"
  ...
  public static void hint() {
    String [][] gameHints = { {"1st hint \b", "Spelling is important."}, {"2nd hint \b", "Look at everything carefully."}, {"3rd hint \b", "Search through items when you feel the need."}, {"5th hint\b", "You can't carry furnature in your bag?"}, {"6th hint\b", "Really? You need another hint?"} };
